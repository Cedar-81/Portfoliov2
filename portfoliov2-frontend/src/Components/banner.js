  ...
  return (
    <div className="lg:flex lg:max-w-screen lg:justify-between lg:h-screen">
      <div className="xl:mt-12 w-full">
        <div className="w-screen lg:max-w-[50%] flex justify-center items-center flex-col px-[5%] lg:pl-[8%] pt-11 pb-9 lg:w-[100%] lg:block">
        ...
        <div className="w-full flex justify-end">
          <div className="px-[5%] lg:pl-[8%] lg:max-w-[50%]">
            <div className="lg:w-full lg:flex lg:justify-end">
              <div className="mt-9 lg:text-right">
                <h3 className="text-lg font-medium">Hobbies</h3>
                <p className="">Writing, Singing</p>
              </div>
            </div>
            <div className="mt-9 lg:flex lg:items-start">
              <div className="text-right lg:text-right">
                <h3 className="text-lg font-medium">Contact</h3>
                <p className="">cedarwudnovels@gmail.com</p>
              </div>
              <div className="flex flex-row pt-[3.5rem] pb-6 ml-8 lg:flex-row lg:pt-0 lg:pb-0 lg:items-start">
