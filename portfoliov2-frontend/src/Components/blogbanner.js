...
const Blogbanner = () => {
  return (
    <div className='w-screen h-screen relative flex items-end justify-end blog_banner text-white bg-no-repeat bg-cover bg-center'>
        <div className='relative z-10 px-[5%] mb-6'>
            <p className='text-lg font-light'>FEATURED</p>
            <h1 className='text-2xl leading-snug mt-1 font-medium'>Coding Tips: How to avoid coding mistakes</h1>
